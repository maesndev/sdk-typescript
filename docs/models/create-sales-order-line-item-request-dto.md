...
```typescript
import { CreateSalesOrderLineItemRequestDto } from "@maesn/typescript-sdk/models";

let value: CreateSalesOrderLineItemRequestDto = {};
```
...
| `lineNumber`              | *string*                  | :heavy_minus_sign:        | N/A                       |
| `optional`                | *boolean*                 | :heavy_minus_sign:        | N/A                       |
| `parentLineNumber`        | *string*                  | :heavy_minus_sign:        | N/A                       |
