# CreateInvoiceRequestDtoTaxRule

## Example Usage

```typescript
import { CreateInvoiceRequestDtoTaxRule } from "@maesn/typescript-sdk/models";

let value: CreateInvoiceRequestDtoTaxRule = "OSS_GOODS";
```
