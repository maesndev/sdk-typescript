...
| `companyId`                                                                                                                                                           | *string*                                                                                                                                                              | :heavy_minus_sign:                                                                                                                                                    | Optional company id to store as the end user's company selection (e.g. a Tripletex accountant client company), so the account and its company are set up in one call. |
