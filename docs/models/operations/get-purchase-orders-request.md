...
```typescript
import { GetPurchaseOrdersRequest } from "@maesn/typescript-sdk/models/operations";

let value: GetPurchaseOrdersRequest = {};
```
...
| `limit`                                                                                   | [operations.GetPurchaseOrdersLimit](../../models/operations/get-purchase-orders-limit.md) | :heavy_minus_sign:                                                                        | N/A                                                                                       |
