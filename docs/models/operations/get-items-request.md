...
```typescript
import { GetItemsRequest } from "@maesn/typescript-sdk/models/operations";

let value: GetItemsRequest = {};
```
...
| `limit`                                                                            | [operations.GetItemsLimit](../../models/operations/get-items-limit.md)             | :heavy_minus_sign:                                                                 | N/A                                                                                |
...
| `type`                                                                             | *string*                                                                           | :heavy_minus_sign:                                                                 | Filter items by type                                                               |
| `itemNumber`                                                                       | *string*                                                                           | :heavy_minus_sign:                                                                 | Filter items by item number                                                        |
