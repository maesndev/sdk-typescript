...
<!-- UsageSnippet language="typescript" operationID="handleCallback" method="post" path="/events/callback/{code}" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="getCode" method="post" path="/events/key/{code}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
<!-- UsageSnippet language="typescript" operationID="handleConfigurationCallback" method="post" path="/events/configuration/callback/{code}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
