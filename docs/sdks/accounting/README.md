...
<!-- UsageSnippet language="typescript" operationID="getDimensionsByDimension" method="get" path="/accounting/dimensions/{dimension}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.getDimensionsByDimension({
    dimension: "<value>",
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingGetDimensionsByDimension } from "@maesn/typescript-sdk/funcs/accounting-get-dimensions-by-dimension.js";
...
async function run() {
  const res = await accountingGetDimensionsByDimension(maesn, {
    dimension: "<value>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("accountingGetDimensionsByDimension failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="updateItem" method="put" path="/accounting/items/{itemId}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.updateItem({
    itemId: "<id>",
    body: {},
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingUpdateItem } from "@maesn/typescript-sdk/funcs/accounting-update-item.js";
...
async function run() {
  const res = await accountingUpdateItem(maesn, {
    itemId: "<id>",
    body: {},
  });
  if (res.ok) {
    ...
    console.log("accountingUpdateItem failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateItemRequest](../../models/operations/update-item-request.md)                                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.UpdateItemResponse](../../models/operations/update-item-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="deleteItem" method="delete" path="/accounting/items/{itemId}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.deleteItem({
    itemId: "<id>",
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingDeleteItem } from "@maesn/typescript-sdk/funcs/accounting-delete-item.js";
...
async function run() {
  const res = await accountingDeleteItem(maesn, {
    itemId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("accountingDeleteItem failed:", res.error);
  }
}
...
**Promise\<[operations.DeleteItemResponse](../../models/operations/delete-item-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getJournalEntriesAsync" method="get" path="/accounting/journalEntries/async" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.getJournalEntriesAsync();
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingGetJournalEntriesAsync } from "@maesn/typescript-sdk/funcs/accounting-get-journal-entries-async.js";
...
async function run() {
  const res = await accountingGetJournalEntriesAsync(maesn);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("accountingGetJournalEntriesAsync failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetJournalEntriesAsyncRequest](../../models/operations/get-journal-entries-async-request.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetJournalEntriesAsyncResponse](../../models/operations/get-journal-entries-async-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="updateJournalEntry" method="put" path="/accounting/journalEntries/{journalEntryId}" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.updateJournalEntry({
    journalEntryId: "<id>",
    body: {},
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingUpdateJournalEntry } from "@maesn/typescript-sdk/funcs/accounting-update-journal-entry.js";
...
async function run() {
  const res = await accountingUpdateJournalEntry(maesn, {
    journalEntryId: "<id>",
    body: {},
  });
  if (res.ok) {
    ...
    console.log("accountingUpdateJournalEntry failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateJournalEntryRequest](../../models/operations/update-journal-entry-request.md)                                                                                | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="getOpenItemsAsync" method="get" path="/accounting/openItems/async" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.getOpenItemsAsync();
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingGetOpenItemsAsync } from "@maesn/typescript-sdk/funcs/accounting-get-open-items-async.js";
...
async function run() {
  const res = await accountingGetOpenItemsAsync(maesn);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("accountingGetOpenItemsAsync failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetOpenItemsAsyncRequest](../../models/operations/get-open-items-async-request.md)                                                                                 | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetOpenItemsAsyncResponse](../../models/operations/get-open-items-async-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="createCreditNote" method="post" path="/accounting/creditNotes" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.createCreditNote({
    body: {
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingCreateCreditNote } from "@maesn/typescript-sdk/funcs/accounting-create-credit-note.js";
...
async function run() {
  const res = await accountingCreateCreditNote(maesn, {
    body: {
      creditNoteDate: "<value>",
      creditNoteLines: [],
    },
  ...
  if (res.ok) {
    ...
    console.log("accountingCreateCreditNote failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.CreateCreditNoteRequest](../../models/operations/create-credit-note-request.md)                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.CreateCreditNoteResponse](../../models/operations/create-credit-note-response.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getCreditNoteDocuments" method="get" path="/accounting/creditNotes/{creditNoteId}/documents" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.getCreditNoteDocuments({
    creditNoteId: "<id>",
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingGetCreditNoteDocuments } from "@maesn/typescript-sdk/funcs/accounting-get-credit-note-documents.js";
...
async function run() {
  const res = await accountingGetCreditNoteDocuments(maesn, {
    creditNoteId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("accountingGetCreditNoteDocuments failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetCreditNoteDocumentsRequest](../../models/operations/get-credit-note-documents-request.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.GetCreditNoteDocumentsResponse](../../models/operations/get-credit-note-documents-response.md)\>**
...
## createBookingProposalAsync

### Example Usage

<!-- UsageSnippet language="typescript" operationID="createBookingProposalAsync" method="post" path="/accounting/bookingProposals/async" -->
```typescript
import { Maesn } from "@maesn/typescript-sdk";
...
async function run() {
  const result = await maesn.accounting.createBookingProposalAsync({
    body: {},
  });
...
```typescript
import { MaesnCore } from "@maesn/typescript-sdk/core.js";
import { accountingCreateBookingProposalAsync } from "@maesn/typescript-sdk/funcs/accounting-create-booking-proposal-async.js";
...
async function run() {
  const res = await accountingCreateBookingProposalAsync(maesn, {
    body: {},
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("accountingCreateBookingProposalAsync failed:", res.error);
  }
}
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.CreateBookingProposalAsyncRequest](../../models/operations/create-booking-proposal-async-request.md)                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.CreateBookingProposalAsyncResponse](../../models/operations/create-booking-proposal-async-response.md)\>**
