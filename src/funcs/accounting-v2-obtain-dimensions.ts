...
export function accountingV2ObtainDimensions(
  client: MaesnCore,
  request?: operations.GetDimensionsV2Request | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDimensionsV2Response,
    | MaesnError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetDimensionsV2Request$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/accounting/v2/dimensions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDimensionsV2Response$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
