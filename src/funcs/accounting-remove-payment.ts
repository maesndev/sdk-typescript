...
export function accountingRemovePayment(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.DeletePaymentRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/accounting/payments/{paymentId}")(pathParams);
