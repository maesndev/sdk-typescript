...
export function tenantsGetRegisteredSystems(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetRegisteredSystemsRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/tenants/get-registered-systems")();
