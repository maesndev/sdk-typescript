...
export function tenantsUpdateSubmissionPageStyle(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.SubmissionPageStyleDto$outboundSchema, value),
  ...
  const path = pathToFunc("/tenants/submission-page-style")();
