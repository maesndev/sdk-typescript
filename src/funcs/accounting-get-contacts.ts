...
export function accountingGetContacts(
  client: MaesnCore,
  request?: operations.GetContactsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetContactsResponse,
    | MaesnError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetContactsRequest$outboundSchema), value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetContactsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
