...
export function tenantsSystemRegistration(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SystemRegistrationRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/tenants/register-system")();
