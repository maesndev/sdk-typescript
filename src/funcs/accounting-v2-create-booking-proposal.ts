...
export function accountingV2CreateBookingProposal(
  client: MaesnCore,
  request: operations.CreateBookingProposalV2Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.CreateBookingProposalV2Response,
    | MaesnError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CreateBookingProposalV2Request$outboundSchema, value),
  ...
  const path = pathToFunc("/accounting/v2/bookingProposals")();
  ...
  const context = {
    ...
    operationID: "createBookingProposalV2",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CreateBookingProposalV2Response$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
