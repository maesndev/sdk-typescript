...
export function accountingRetrieveVendorCredits(
  client: MaesnCore,
  request?: operations.GetVendorCreditsRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetVendorCreditsResponse,
    | MaesnError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetVendorCreditsRequest$outboundSchema),
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetVendorCreditsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
