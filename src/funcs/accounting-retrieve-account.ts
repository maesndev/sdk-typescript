...
export function accountingRetrieveAccount(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetAccountRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/accounting/accounts/{accountId}")(pathParams);
