...
export function tenantsGetTargetSystemValues(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetTargetSystemValuesRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/tenants/get-target-system-values")();
