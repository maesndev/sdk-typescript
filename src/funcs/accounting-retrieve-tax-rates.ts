...
export function accountingRetrieveTaxRates(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(operations.GetTaxRatesRequest$outboundSchema), value),
  ...
  const path = pathToFunc("/accounting/taxRates")();
