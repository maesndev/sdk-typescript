...
export function contactsV2Get(
  client: MaesnCore,
  request: operations.GetContactV2Request,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetContactV2Response,
    | MaesnError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetContactV2Request$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetContactV2Response$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
