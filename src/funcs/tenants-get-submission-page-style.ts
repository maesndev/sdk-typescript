...
export function tenantsGetSubmissionPageStyle(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetSubmissionPageStyleRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/tenants/get-submission-page-style")();
