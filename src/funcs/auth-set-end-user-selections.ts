...
export function authSetEndUserSelections(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SetEndUserSelectionsRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/setEndUserSelections")();
  ...
  const context = {
    ...
    operationID: "setEndUserSelections",
    oAuth2Scopes: null,
