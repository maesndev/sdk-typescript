...
export function authGetEnvironmentPage(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetEnvironmentPageRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/selections")();
  ...
  const context = {
    ...
    operationID: "getEnvironmentPage",
    oAuth2Scopes: null,
