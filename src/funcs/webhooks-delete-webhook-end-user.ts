...
export function webhooksDeleteWebhookEndUser(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.DeleteWebhookEndUserRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/webhooks/user/{webhookId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "deleteWebhookEndUser",
    oAuth2Scopes: null,
