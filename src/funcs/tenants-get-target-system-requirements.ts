...
export function tenantsGetTargetSystemRequirements(
  client: MaesnCore,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(
          operations.GetTargetSystemRequirementsRequest$outboundSchema,
        ),
        value,
      ),
  ...
  const path = pathToFunc("/tenants/get-target-system-requirements")();
