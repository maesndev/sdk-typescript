...
export const ContactAddressV2CountryCode = {
  Ad: "AD",
  Ae: "AE",
  Af: "AF",
  Ag: "AG",
...
export const ContactAddressV2Type = {
  Billing: "BILLING",
  Delivery: "DELIVERY",
  Private: "PRIVATE",
  Work: "WORK",
...
export type ContactAddressV2 = {
  ...
  city: string | null;
  countryCode: ContactAddressV2CountryCode | null;
  postalCode: string | null;
  type: ContactAddressV2Type;
};
...
> = z.object({
  ...
  countryCode: types.nullable(ContactAddressV2CountryCode$inboundSchema),
  postalCode: types.nullable(types.string()),
  type: ContactAddressV2Type$inboundSchema,
});

export function contactAddressV2FromJSON(
  jsonString: string,
): SafeParseResult<ContactAddressV2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ContactAddressV2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ContactAddressV2' from JSON`,
  );
}
