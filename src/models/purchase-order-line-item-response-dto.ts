...
/** @internal */
export const PurchaseOrderLineItemResponseDto$inboundSchema: z.ZodMiniType<
...
export function purchaseOrderLineItemResponseDtoFromJSON(
  jsonString: string,
): SafeParseResult<PurchaseOrderLineItemResponseDto, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PurchaseOrderLineItemResponseDto$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PurchaseOrderLineItemResponseDto' from JSON`,
  );
}
